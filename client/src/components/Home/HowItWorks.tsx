            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-gray-900">
                        Prêt et opérationnel en <span className="text-primary-500 italic">quelques minutes</span>
                    </h2>
                ...
                <div className="space-y-6">
                    {steps.map((s, i) => (
                        <div key={s.step} className="flex gap-6 items-start">
                            <div className="shrink-0 size-12 rounded-2xl bg-primary-50 border border-primary-100 flex items-center justify-center">
                                <span className="text-sm font-medium text-primary-500">{s.step}</span>
                            </div>
                            <div className="pt-1">
