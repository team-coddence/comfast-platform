...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome bar */}
      <div>
        <h2 className="text-2xl text-slate-900">Bon! 👋</h2>
        <p className="text-slate-500 text-sm mt-0.5">
          Voici ce qui se passe sur vos comptes sociaux aujourd'hui.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {statCards.map((card) => (
          <div
            key={card.label}
            className="bg-white hover:bg-primary-50 relative border border-slate-200 rounded-2xl p-5 hover:border-primary-200 transition-all"
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-xs absolute right-4 top-4 text-primary-500 flex items-center gap-1">
        ...
        {activities.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-6">
            ...
            <p className="text-slate-400 text-sm mt-1">
              Connectez des comptes et planifiez des messages pour voir les
              événements ici.
            </p>
          </div>
        ) : (
